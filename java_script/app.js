...
const JUNTA = [
  ...
  { nombre: 'Niurka',    rol: 'Coord. de Relaciones Institucionales', emoji: '👩‍💻', presentacion: 'Soy egresada del CMSPP-COAR LIMA y estudió  medicina en la Universidad Científica del Sur. Soy de Villa el Salvador y tengo 17 años.',     objetivos: 'Convertir a VAP en una ruta mediante la cual podré llegar a adolescentes y jóvenes de diversos lugares y promover conciencia sobre las problemáticas presentes en el país, fomentando el desarrollo de las ODS y el deseo de conseguir un cambio.',  hobbies: 'Me encanta disfrutar y explorar distintos géneros musicales, experimentar diferentes técnicas artísticas. Disfruto mucho de cocinar platillos y postres. De vez en cuando veo animes o series.' },
...
const VOLUNTARIOS = [
  ...
  { nombre: 'Bryen',      rol: 'Voluntario', emoji: '👩‍💻', presentacion: 'Soy alumno de la universidad Nacional Tecnológica de Lima Sur de la carrera ing. Ambiental, actualmente tengo 19 años.',       objetivos: 'Con la ayuda de voces al poder buscó concientizar sobre el tema ambiental, que los jóvenes y adultos tengan en cuenta, la gran importancia de cuidar el ambiente para prevenir y concientizar los  problemas regionales y globales como la bancarrota hídrica mundial.', hobbies: 'Juego basket, soy de los chicos que le gusta el anime, series y películas, escucho diversidad de música y realizó experimentos cada cierto tiempo.'},
  { nombre: 'Belén',     rol: 'Voluntaria',  emoji: '👩‍💻', presentacion: 'Soy Belén Huanca Vinces del colegio Técnico 6066, estudió contabilidad y tengo 15 años',    objetivos: 'En voces al poder me gusta estar  informada sobre temas políticos y mantenerme al tanto en lo que sucede en el Perú.',  hobbies: 'Hobbies: Escuchar música jugar videojuegos y participar en voces al poder.' },
